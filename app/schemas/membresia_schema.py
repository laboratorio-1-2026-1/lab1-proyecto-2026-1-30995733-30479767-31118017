...
class MembresiaCreate(BaseModel):
    ...
    fecha_inicio: date
    estado: Optional[bool] = Field(default=True, description="True = Activa, False = Suspendida")

class MembresiaResponse(MembresiaCreate):
    id_membresia: int
    fecha_fin: date = Field(description="Calculada matemáticamente por el sistema")
